...
public final class RequestValidator {
    ...
    public static void validate(EventRequest eventRequest) throws InvalidEventRequestException{
        ...
        if(meta.getConnectionInfo() == null
                || !(meta.getConnectionInfo().equals("mobile") || meta.getConnectionInfo().equals("wifi")) ){
            throw new InvalidEventRequestException("Invalid connection info: " + meta.getConnectionInfo() + " . It must be 'wifi' or 'mobile'");
        }
    }
